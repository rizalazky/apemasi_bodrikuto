...
//       membaca data (kolom ke-1 sd terakhir)
      ...
      $jam 		        = $data->val($i, 8);
      $status         = $data->val($i, 9);
      $petugas   		  = $data->val($i, 10);
	    //      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT INTO elevasi (id_elevasi,kode, bendung, elevasi, debit, Qka, Qki, tgl, jam, status, petugas) values('','$kode','$bendung','$elevasi','$debit','$Qka','$Qki','$tgl','$jam','$status','$petugas')";
