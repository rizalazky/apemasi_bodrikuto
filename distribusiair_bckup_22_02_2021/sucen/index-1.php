...
for ($i=1;$i<=56;$i++){
$urut=$i-60;
$d = mysql_fetch_array(mysql_query("SELECT id,q_diberikan FROM `alokasi` WHERE id='$urut' AND di='SCN' ORDER BY id ASC"));
?>
<-div id="wb_element_instance<?php echo $i;?>" class="wb_element" style=" line-height: normal;"><p class="wb-stl-custom1" style="text-align: left;"><span style="color:#000000;">Q: <?php $dbt=$d['q_diberikan'];echo $dbt;?> m3</span></p></div>
<?php } ?>
