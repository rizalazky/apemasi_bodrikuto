...
<div id="wb_element_instance8" class="wb_element wb_element_shape"><div class="wb_shp"></div></div><div id="wb_element_instance9" class="wb_element" style=" line-height: normal;"><h3 class="wb-stl-heading3" style="text-align: center;"><strong>SKEMA DISTRIBUSI AIR DAERAH IRIGASI SUCEN</strong></h3>
...
</div><div id="wb_element_instance12" class="wb_element" style=" line-height: normal;"><p class="wb-stl-normal"><strong>:&nbsp; Sungai Sucen</strong></p>
</div><div id="wb_element_instance13" class="wb_element" style=" line-height: normal;"><p class="wb-stl-normal"><strong>:&nbsp; 596 Ha</strong></p>
</div><div id="wb_element_instance14" class="wb_element" style=" line-height: normal;"><p class="wb-stl-normal"><strong>Lokasi&nbsp;</strong></p>
</div><div id="wb_element_instance15" class="wb_element" style=" line-height: normal;"><p class="wb-stl-normal"><strong>:&nbsp; Salatiga, Kab. Semarang</strong></p>
...
</div><div id="wb_element_instance29" class="wb_element"><a class="wb_button" href="../../uplod/<?php echo $nama_file_a; ?>"><span>Download Perhitungan Distribusi Air</span></a></div><div id="wb_element_instance30" class="wb_element"><a class="wb_button" href="../../uplod/<?php echo $nama_file_k;?>"><span>Download Perhitungan Faktor K</span></a></div>
<div id="wb_element_instance31" class="wb_element wb_element_picture"><img alt="gallery/bgsa" src="index_files/985387db8d45f9262632b541ce59e9fb_250x146.jpg"></div>
...
<?php
		$area = array(0.48, 0.32, 0.24, 1.45, 2.41, 9.56, 1.45, 2.01, 1.53, 0.24, 40.60, 13.02, 48.82, 5.24, 5.73, 1.37, 1.45, 1.45, 1.20, 0.72, 15.85, 5.08, 0.24, 39.56, 0.24, 0.48, 1.53, 1.57, 0.24, 1.33, 0.24, 0.24, 3.54, 19.30, 5.27, 4.82, 6.51, 42.84, 12.22, 41.49, 3.06, 9.00, 10.45, 24.84, 35.00, 30.07, 63.55, 0.64, 6.11, 3.05, 16.86, 0.48, 0.48, 6.67, 6.67, 37.19);
		$lokasi = array(
			"CSc. 1 ka", "CSc.Ki. 1 ka", "CSc.Ki. 2 ka", "CSc.Ki. 3 ka", "CSc.Ki. 4 ka", "Sc.Ki. 1 ka", "CSc.Ki. 5 ka", "CSc.Ki. 6 ka", "CSc.Ki. 7 ka", "CSc.Ki. 8 ka", "Sc.Ki. 2 ka", "Sc.Ki. 3 ka", "Sc.Ki. 4 ka", "CSc.Ki. 9 ka", "CSc.Ki. 10 ka", "CSc.Ki. 11 ka", "CSc.Ki. 12 ka", "CSc.Ki. 13 ka", "CSc.Ki. 14 ka", "CSc.Ki. 15 ka", "Sc.Ki. 5 ka", "CSc.Ki. 16 ka", "CSc.Ki. 17 ka", "Sc.Ki. 6 ka", "CSc.Ka. 1 ki", "CSc.Ka. 2 ki", "CSc.Ka. 3 ki", "CSc.Ka. 4 ki", "CSc.Ka. 5 ki", "CSc.Ka. 6 ki", "CSc.Ka. 7 ki", "CSc.Ka. 8 ki", "CSc.Ka. 9 ki", "Sc.Ka. 1 ki", "Sc.Ka. 2 ki", "CSc.Ka. 10 ki", "Sc.Ka. 3 ki", "GL. 1 ki", "Cr.GL. 1 ka", "GL. 2 ka", "Cr.GL. 2 ka", "GL. 3 ka", "GL. 4a ka", "GL. 4 ka", "GL. 5 ka", "GL. 6 ka", "GL. 6 ", "CKd. 1 ki", "CKd. 2 ki", "CKd. 3 ki", "Kd. 1 ki", "CKd. 4 ki", "CKd. 5 ki", "CKd. 6 ki", "Kd. 2 ki", "Kd. 2 ka"
		);
		...
		for ($i = 1; $i <= 56; $i++) {
			$urut = $start + $i;
			$q = mysql_fetch_array(mysql_query("SELECT id,q_diberikan FROM `alokasi` WHERE id='$urut' AND di='SCN' ORDER BY id ASC"));
			?>
